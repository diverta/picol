...
export const SpecialOperations = {
  login: AuthenticationService.postAuthenticationServiceRcmsApi1Login,
  logout: AuthenticationService.postAuthenticationServiceRcmsApi1Logout,
  token: AuthenticationService.postAuthenticationServiceRcmsApi1Token,
};
