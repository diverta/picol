self.addEventListener('fetch', e => {
  const cache_url = e.request.url.substring(0,100);

  if (cache_url.indexOf('storage.googleapis.com/picol-c8553.appspot.com') == -1) {
    return;
  }

  // For example https://storage.googleapis.com/picol-c8553.appspot.com/files/topics/809_ext_04_0.jpg?GoogleAccessId=
  const cache_nm = 'picol-c8553.appspot.com';
